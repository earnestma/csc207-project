...
public class SelectDeleteTaskUseCaseFactory {
    ...
    public static SelectDeleteTaskController createSelectDeleteTaskUseCase(ViewModelManager viewModelManager,
        ...
        SelectDeleteTaskPresenter selectDeleteTaskPresenter = new SelectDeleteTaskPresenter(viewModelManager, deleteTaskViewModel);
        SelectDeleteTaskInteractor selectDeleteTaskInteractor = new SelectDeleteTaskInteractor(selectDeleteTaskPresenter);
